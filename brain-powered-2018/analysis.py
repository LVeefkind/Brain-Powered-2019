...
# hier moeten we dan onze data in gooien
# def analysis(c1, c2, sample_rate=256, length=0.2):
...
# hier moeten we onze c1 c2 bestanden in gooien (we hebben er meer toch?)
...
#         c1 = load_eeg_mat(p1)
#         c2 = load_eeg_mat(p2)
#         exp = analysis(c1, c2, sample_rate, length)
#         results[folder] = exp
#         if VERBOSE:
