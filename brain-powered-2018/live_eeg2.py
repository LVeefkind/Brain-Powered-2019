...
# py live_eeg.py -c' "KLAAS.npy" -d "KLA"
# py classifier.py "KLAAS.npy"
...
def label_classification( prediction,route_index,route_list):
    ...
    # if prediction == route_list[route_index]:
...
def load_calibration(filename):
    ...
    return np.load('Kelly.npy',allow_pickle=True).T
...
def init(args, filename='calibrations/data.csv'):
    if args.calibration_file:
        ...
        print('doe calibratie met -c Kelly.npy')
    # show_calibration(calibration)
